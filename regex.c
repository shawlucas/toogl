...
regexp* regcomp(const char* exp)
{
    ...
    regnpar = 1;
    regsize = 0L;
    regcode = (char*)&regdummy; /* cast shuts up a false compiler warning */
    regc(MAGIC);
    if (reg(0, &flags) == NULL) {
        return (NULL);
    }
 ...
 */
static char* reg(paren, flagp) int paren; /* Parenthesized? */
int* flagp;
{
    register char* ret;
    register char* br;
 ...
 */
static char* regpiece(flagp) int* flagp;
{
    register char* ret;
    register char op;
    register char* next;
 ...
 */
static char* regatom(flagp) int* flagp;
{
    register char* ret;
    int flags;
 ...
 */
int regexec(prog, string) register regexp* prog;
...
static int /* 0 failure, 1 success */
    regtry(prog, string) regexp* prog;
char* string;
{
    register int i;
    register char** sp;
...
static int strcspn(s1, s2) char* s1;
char* s2;
{
    register char* scan1;
    register char* scan2;
